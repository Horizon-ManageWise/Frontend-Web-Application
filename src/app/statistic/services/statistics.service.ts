...
export class StatisticsService {
  ...
  updateUserStory(story: Statistics): Observable<Statistics> {
      return this.http.put<Statistics>(`https://my-json-server.typicode.com/CB-Sergio-AGV/db/userStories/${story.id}`, story);
    }
